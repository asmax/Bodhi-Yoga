                  ...
                  ?>
                    ...
                    <?php if ( !empty( $teacher_course_information )) : ?>
                        ...
                        <div class="course-info--inner">
                            ...
                            <div class="course--heading collapsed" role="tab" id="heading-<?php echo $counter ?>"  data-toggle="collapse" data-parent="#accordion" href="#collapse-<?php echo $counter ?>" aria-expanded="true" aria-controls="collapse-<?php echo $counter ?>">

                                <?php if ( isset($course_info['course_tab_title'])) {

                                    echo '<h4 class="size-22 font-bradley course-title">'.$course_title.'</h4>';                
...
// register button url
$bodhi_value = TitanFramework::getInstance( 'bodhi-yoga' );
$bodhi_register_button_url = $bodhi_value->getOption( 'bodhi_register_button_url' );
if ( ! empty( $bodhi_register_button_url )): ?>
    <div class="text-center register--button">
        <a href="<?php echo $bodhi_register_button_url ?>" class="btn btn-primary btn-lg">Register Now <i class="fa fa-angle-right"></i></a>
    </div>
<?php endif ?>
