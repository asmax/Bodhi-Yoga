 ...
 */
require_once dirname( __FILE__ ) . '/plugins-activation.php';

add_action( 'tgmpa_register', 'bodhi_yoga_register_required_plugins' );
function bodhi_yoga_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'advcustfpro',
			'source'             => FRAMEWORK_URI . 'inc/plugins/advcustfpro.zip',
			'required'           => true,
			'version'            => '',
